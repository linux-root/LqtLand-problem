...
import lqt.ltqland.Solution
import org.scalatest.funsuite.AnyFunSuite
import org.scalatest.matchers.should.Matchers

class LtqLandSuite extends AnyFunSuite with Matchers {

  test("1. The distance of the route A-B-C") {
    Solution.distanceThroughCities("A", "B", "C") shouldBe "9"
  }

  test("2. The distance of the route A-D") {
    Solution.distanceThroughCities("A", "D") shouldBe "5"
  }

  test("3. The distance of the route A-D-C") {
    Solution.distanceThroughCities("A", "D", "C") shouldBe "13"
  }

  test("4. The distance of the route A-E-B-C-D") {
    Solution.distanceThroughCities("A", "E", "B", "C", "D") shouldBe "22"
  }

  test("5. The distance of the route A-E-D") {
    Solution.distanceThroughCities("A", "E", "D") shouldBe "NO SUCH ROUTE"
  }
  ...
  test("""6. The number of trips starting at C and ending at C with a maximum of 3 stops.
     ...
     */
    Solution.totalPathsWithBoundedStops("C", "C", 4) shouldBe 2
  }
